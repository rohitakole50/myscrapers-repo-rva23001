...
# 4. LLM_MODEL set to 'gemini-2.5-flash' (Fixes 404/NotFound error). <--- NEW FIX
# 5. "additionalProperties": False removed from schema (Fixes internal ParseError). <--- NEW FIX
...
# FIX 1: Using gemini-2.5-flash as default to address the 404 NotFound error
